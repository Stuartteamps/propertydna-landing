...
async function run() {
  ...
  if (!text) {
    ...
    const FALLBACK = [
      ...
      "A $10M Palm Springs estate with a verified historic designation qualifies for California's Mills Act — income-capitalization assessment instead of market value. On a $10M property, that's typically $22k/year in property taxes vs. $110k/year. $88k annual savings, ~$680k NPV over 10 years. PropertyDNA builds the attribution documentation that makes the application viable. https://www.thepropertydna.com",
