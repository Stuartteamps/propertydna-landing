...
async function run() {
  ...
  if (!text) {
    ...
    const FALLBACK = [
      "John Lautner designed 8 residential commissions in Palm Springs. Not 8 on the market — 8 ever built. Two are now off the private market permanently. When one of the remaining few trades, the next comparable may not surface for 7 years. That's collectible scarcity, not real estate inventory. PropertyDNA builds the provenance infrastructure this tier has always deserved. https://www.thepropertydna.com",
      "We evaluated 240+ Palm Springs homes claiming MCM architect attribution against primary sources: original drawings, building permits, period press. 63% verified. 18% don't hold up. At a $10M+ transaction, discovering which category applies at the wire is expensive. PropertyDNA answers that question before LOI. https://www.thepropertydna.com",
      "A vintage Scotch whisky has better documented provenance than most $12M architectural estates. A 1926 Macallan has distillery records, a complete auction trail, and authentication papers. A Richard Neutra original in Palm Springs has a title chain and listing notes. PropertyDNA is closing that gap — verified architect attribution, celebrity ownership chains, modification chronology. https://www.thepropertydna.com",
      "Elvis and Priscilla spent their honeymoon at 1350 Ladera Circle, Palm Springs, May 1–7, 1967 — AP wire May 2, 1967; Palm Springs Life Summer 1967; Priscilla's memoir pp. 197–201. William Krisel's 'House of Tomorrow' circular design for the Alexander company. That's what verified celebrity provenance looks like: deed records and contemporaneous press, not biography passages. PropertyDNA builds it for the Coachella Valley's $5M+ market. https://www.thepropertydna.com",
