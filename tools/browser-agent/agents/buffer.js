...
async function run() {
  ...
  if (!text) {
    ...
    const FALLBACK = [
      "A bottle of 1978 Domaine Romanée-Conti comes with a full Chambolle-Musigny extract, a complete auction trail, and an import certificate chain. For an $18,000 bottle. The Kaufmann Desert House — Richard Neutra, 1946, Julius Shulman's 'Poolside Gossip' in the Getty — sold at nine-figure territory with a title chain and MLS listing as the primary documentation. PropertyDNA is building what the top of the residential market has always needed: a complete, archive-verified provenance file. Same standard every other serious collectible category demands. https://www.thepropertydna.com",
