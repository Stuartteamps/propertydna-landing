...
async function run() {
  ...
  if (!text) {
    ...
    const FALLBACK = [
      "Marilyn Monroe's Palm Springs villa (1326 Rose Ave) is one of the most-searched celebrity estates in the Coachella Valley. But the standard listing history doesn't carry what makes the provenance investment-grade: verified occupancy period, deed chain from original owner, period press record. PropertyDNA builds the documentation that converts a historical claim into a verified, transferable provenance file — indexed against primary sources, not marketing copy. https://www.thepropertydna.com",
      "Frank Sinatra's Twin Palms Estate (1148 E Alejo Rd, Palm Springs) is one of the most documented celebrity properties in California — architect E. Stewart Williams, permitted 1947, Sinatra occupant 1948–1954, deed records public. What hasn't existed is the indexed, investment-grade provenance file connecting the deed chain to the period cultural record: the Life magazine coverage, the Rat Pack documentation, the Williams commission archive at the Palm Springs Art Museum. Celebrity provenance adds a material, measurable premium to architecturally significant residential — but only when it survives verification. PropertyDNA builds the dossier that makes that premium portable across transactions. https://www.thepropertydna.com",
