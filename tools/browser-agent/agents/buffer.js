...
async function run() {
  ...
  if (!text) {
    ...
    const FALLBACK = [
      "There are 8 verified John Lautner residential commissions in Palm Springs. When one trades, it resets the comparable market for years. PropertyDNA builds the scarcity index, provenance file, and architect attribution dossier — the data layer that makes a sophisticated buyer's LOI hold. https://www.thepropertydna.com",
      "When a buyer's attorney discovers at the wire that an architect attribution claim doesn't trace to primary sources, the renegotiation is typically 8–15% — or a deal kill. PropertyDNA verifies Palm Springs $5M+ estate provenance before listing: original drawings, deed records, period press. No surprises at the wire. https://www.thepropertydna.com",
