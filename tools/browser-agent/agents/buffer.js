...
async function run() {
  ...
  if (!text) {
    ...
    const FALLBACK = [
      "When Pétrus 1961 sells at Christie's, the buyer receives the négociant allocation records, cellar provenance chain, and authentication by the estate. A $9M Palm Springs architectural estate — documented Frey commission, period press, deed chain intact — gets an MLS listing and unverified agent notes. The Bordeaux market figured this out. PropertyDNA is building the wine-cave equivalent for $5M+ residential: verified archive attribution, ownership chronology, period cultural documentation, indexed and searchable. The asset deserves the dossier. https://www.thepropertydna.com",
