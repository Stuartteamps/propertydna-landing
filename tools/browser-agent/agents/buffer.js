...
async function run() {
  ...
  if (!text) {
    ...
    const FALLBACK = [
      "John Lautner built 8 residential commissions in Palm Springs. Richard Neutra built 12. When one trades, it resets the comparables for a decade — alt-asset scarcity mechanics, not typical real estate liquidity. PropertyDNA indexes trade frequency, scarcity premiums, and comparable rarity for every architect-attributed estate in the Coachella Valley. https://www.thepropertydna.com",
      ...
      "California's Mills Act contracts with owners of qualified historic properties to assess them on income-capitalization rather than market value — saving $30k–$80k+ annually on a $10M+ Palm Springs estate. The prerequisite is historic designation, which requires verified architectural attribution documentation. PropertyDNA builds the provenance package that makes the application viable. https://www.thepropertydna.com",
