...
async function run() {
  ...
  if (!text) {
    ...
    const FALLBACK = [
      "Frank Sinatra commissioned Twin Palms from E. Stewart Williams in 1947. His name is on the Riverside County deed. He and Ava Gardner were married there November 7, 1951 — AP wire, the following morning. All of it verifiable in primary sources before buyers ask. That's what verified provenance looks like. PropertyDNA builds it for the Coachella Valley's $5M+ market. https://www.thepropertydna.com",
      ...
      "A first-growth Bordeaux comes with estate bottling records, auction provenance, and storage documentation going back decades. The $15M architectural estate next door gets a title chain and listing notes. Fine wine built its data infrastructure over a century. Luxury real estate hasn't — yet. PropertyDNA builds the provenance infrastructure that top-of-market residential has always deserved, starting with the Coachella Valley. https://www.thepropertydna.com",
