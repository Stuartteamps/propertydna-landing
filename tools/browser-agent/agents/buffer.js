...
async function run() {
  ...
  if (!text) {
    ...
    const FALLBACK = [
      "A 1962 Patek Philippe reference 2499 sold at Christie's for $4.2M in 2023 because the full service history, original dial condition, and consecutive ownership were documented. Trophy residential at $10M+ follows the same logic: scarcity alone doesn't capture premium — scarcity plus verified documentation does. PropertyDNA builds the provenance file that makes architectural significance portable across transactions: verified architect attribution, deed chain, modification chronology, period press record. The gap between claimed and verified provenance is where value is made. https://www.thepropertydna.com",
      "Wine gets a 100-point Parker score. Art gets a TEFAF-standard condition report and full auction trail. Watches get 250-point authentication and consecutive ownership records. Trophy residential above $5M gets an assessor printout and unverified listing notes. The documentation standard at the top of the residential market is 40 years behind every comparable collectible category. PropertyDNA is closing that gap — starting with Palm Springs, where the archive infrastructure (Getty Research Institute, Palm Springs Art Museum Architecture and Design Center, Riverside County permit records) is already in place. The work is connecting them. https://www.thepropertydna.com",
      ...
      "Walt Disney's Smoke Tree Ranch estate, Bob Hope's John Lautner compound, Steve McQueen's Cielo Drive retreat — the Palm Springs celebrity estate record is rich and largely undocumented at investment grade. The deed chains exist. The permit records exist. The period press exists. PropertyDNA is connecting them into the dossier infrastructure this tier of asset has always deserved but never had. https://www.thepropertydna.com",
    ];
