...
const LIST = '67ca835a-4599-11f1-8a1f-02420a320003';

const SUBJECT = "Coachella Valley — your property's actual current value";
...
<p style="margin:0 0 16px;">Quick note from my side. Hope you've been well.</p>
<p style="margin:0 0 16px;">I just built a property intelligence tool that pulls together — for any Coachella Valley address — the kind of detailed analysis we usually only put together when actively buying or selling:</p>
<ul style="margin:0 0 16px;padding-left:20px;line-height:1.8;">
<li><strong>Current market value</strong> based on real comps, not Zillow estimates</li>
<li><strong>Permit history</strong> — every documented renovation</li>
<li><strong>San Andreas + flood + fire</strong> risk profile</li>
<li><strong>Walkable comparable sales</strong> within your specific neighborhood</li>
<li><strong>5-year value trajectory</strong></li>
</ul>
<p style="margin:0 0 16px;">If you've been curious where your property actually stands today — it's free, takes me 60 seconds to pull, and you'll get the full report by email.</p>
...
<a href="https://thepropertydna.com/analyze?ref=cc_gmail_general&email={{contact.email}}" target="_blank" style="display:inline-block;padding:14px 28px;color:#fff;font-size:14px;text-decoration:none;letter-spacing:0.05em;">
...
You're receiving this because you've been in touch with the Stuart Team. <a href="[[UNSUBSCRIBE]]" style="color:#9a8671;">Unsubscribe</a>.<br>
...
const payload = JSON.stringify({
  ...
  campaignName: `Gmail Contacts General - May 15 - ${Date.now()}`,
