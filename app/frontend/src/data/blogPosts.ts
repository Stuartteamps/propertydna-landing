...
export const blogPosts: BlogPost[] = [
...

  {
    ...
    metaDescription: 'PropertyDNA is now a free iOS app delivering institutional-grade property intelligence — valuation, risk, permit history, and confidence-scored verdicts on 1.67M parcels. The data your agent does not want you to see.',
    date: '2026-06-09',
    readTime: 6,
    category: 'Launch',
