...
const db = {
  ...
  from(table) {
    return {
      ...
      like(col, pattern) { this._filters.push(`${col}=like.${encodeURIComponent(pattern)}`); return this; },
      ilike(col, pattern) { this._filters.push(`${col}=ilike.${encodeURIComponent(pattern)}`); return this; },
