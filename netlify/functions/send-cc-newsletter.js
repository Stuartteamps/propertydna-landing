...
function buildHtml(weatherText, marketNarrative, weekLabel) {
  ...
  // Pick the Coachella Valley lifestyle photo for the send day. The daily-runner
  // pre-generates photos at /social/photo/YYYY-MM-DD.jpg so each send has a
  // fresh image instead of the stale stagecoach festival shot.
